...
use App\Http\Requests\VendedorRequest as StoreRequest;
use App\Http\Requests\VendedorRequest as UpdateRequest;

class VendedorCrudController extends CrudController
{
    public function setup()
    {
        ...
        |--------------------------------------------------------------------------
        */
        $this->crud->setModel('App\Models\Vendedor');
        $this->crud->setRoute(config('backpack.base.route_prefix') . '/vendedor');
        $this->crud->setEntityNameStrings('vendedor', 'vendedores');
